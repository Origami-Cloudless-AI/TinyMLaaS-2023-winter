  ...
  'syms': { 'tflm_hello_world.core': { 'tflm_hello_world.core.foo': ('core.html#foo', 'tflm_hello_world/core.py'),
            ...
            'tflm_hello_world.training': { 'tflm_hello_world.training.train_model': ( 'training.html#train_model',
                                           ...
                                           'tflm_hello_world.training.train_model.__init__': ( 'training.html#train_model.__init__',
                                                                                               'tflm_hello_world/training.py'),
                                           'tflm_hello_world.training.train_model.convert_model': ( 'training.html#train_model.convert_model',
                                                                                                    'tflm_hello_world/training.py'),
                                           'tflm_hello_world.training.train_model.convert_to_c_array': ( 'training.html#train_model.convert_to_c_array',
                                                                                                         'tflm_hello_world/training.py'),
                                           'tflm_hello_world.training.train_model.load_data': ( 'training.html#train_model.load_data',
                                                                                                'tflm_hello_world/training.py'),
                                           'tflm_hello_world.training.train_model.plot_size': ( 'training.html#train_model.plot_size',
                                                                                                'tflm_hello_world/training.py'),
